...
export const portfolioData: PortfolioData = {
  ...
  heroSummary:
    'Results-driven Senior Front-End Developer and UI/UX Designer with 14+ years of experience designing and developing responsive web applications, enterprise portals, SaaS platforms, custom Liferay themes, CMS solutions, and customer-centric digital products. Expertise in React.js, JavaScript, TypeScript, HTML5, CSS3, SCSS, Tailwind CSS, Bootstrap, Figma, Adobe XD, and modern front-end development. Proven ability to translate business requirements and UI/UX designs into pixel-perfect, accessible, high-performance, and cross-browser compatible applications. Experienced in building reusable UI components, design systems, REST API integrations, and scalable front-end architectures while collaborating with cross-functional Agile teams. Delivered enterprise solutions across Banking, Finance, Telecom, Insurance, Real Estate, E-commerce, and Technology domains, with a strong focus on performance optimization, accessibility (WCAG), and exceptional user experience.',
  about:
